		...
		{ //任务模式
			...
			{ //任务飞行
				...
				{ //起飞
					...
					break;
					// Position_Control_Takeoff_HeightRelative(50);
					// ++mission_ind;
					// break;
				}
				...
				case 1:
				{
					...
					// {
					// 	openmvflag = 1;
					// 	params[4] = OpenMV.dev_x*0.2;
					// 	params[5] = OpenMV.dev_y*0.2;
					// 	int16_t res = Process_NavCmd( MAV_CMD_NAV_WAYPOINT, freq, MAV_FRAME_BODY_FLU, params, &navInf );
					// 	xSemaphoreGive(openMVMutex);
					// }

					//Position_Control_set_TargetPositionXYRelativeBodyheading(-OpenMV.dev_y*0.2,OpenMV.dev_x*0.2);
					...
					// // 	// 	++mission_ind;
					// // 	// }
					// // 	Position_Control_set_TargetPositionXYRelativeBodyheading(50,0);
					// // 	++mission_ind;
					// // 	break;
					// // Position_Control_set_TargetPositionXYRelativeBodyheading(50,0);
					// // ++mission_ind;
					...
					// 	// Position_Control_set_ZLock();
					// 	// Position_ControlMode alt_mode;
					// 	// get_Position_ControlMode(&alt_mode);
					// 	// if(alt_mode==Position_ControlMode_Position)
					// 	// {//飞行完成
					// 	// 	++mission_ind;
					// 	// }
					...
					// // 	// 	++mission_ind;
					// // 	// }
					// // 	Position_Control_set_TargetPositionXYRelativeBodyheading(0,50);
					// // 	++mission_ind;
					// // 	break;
